...
function $RouteProvider(){
  ...
  this.$get = ['$rootScope', '$location', '$routeParams', '$q', '$injector', '$http', '$templateCache',
     ...
     *
     * @description
     * Is used for deep-linking URLs to controllers and views1 (HTML partials).
...
function createHttpBackend($browser, XHR, $browserDefer, callbacks, rawDocument, locationProtocol) {
  ...
  function jsonpReq(url, done) {
    ...
    // - fetches local scripts1 via XHR and evals them
 ...
 * When one person, perhaps John, views1 the document, "John is viewing" will be shown.
    ...
    compile: function(element, attr) {
      if (attr.type == 'text/ng-template') {
        var templateUrl = attr.id,
            // IE is not consistent, in scripts1 we have to read .text but in other nodes we have to read .textContent
            text = element[0].text;
